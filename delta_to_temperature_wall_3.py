...
delta_3 = 0.06 #外层厚度
Q_max = 236 #允许热损
T_1_assumption = 300 #界面1温度猜测值
T_2_assumption = 200 #界面2温度猜测值
T_s_assumption = 43.9 #表面温度猜测值
...
#传热方程组求解
sol_root = root(GB50264_delta_to_T_s,[Q_max,T_1_assumption,T_2_assumption,T_s_assumption]) 
sol_fsolve = fsolve(GB50264_delta_to_T_s,[Q_max,T_1_assumption,T_2_assumption,T_s_assumption])
Q = sol_fsolve[0]
T_1 = sol_fsolve[1]
T_2 = sol_fsolve[2]
T_s = sol_fsolve[3]
...
#打印结果
print(">>>>>>>>>>> When the delta_1 delta_2 delta_3 is ",delta_1,delta_2,delta_3," :")
