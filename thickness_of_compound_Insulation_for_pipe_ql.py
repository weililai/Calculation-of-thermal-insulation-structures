...
elif W*D_2 > 0.8: #上一版本，20200405版中错写为W > 0.8，20200408版更正全部相关错误！
...
def GB50264_q_to_T_s(x):
    T_s,D_1,D_2 = x[0],x[1],x[2] #方程中哪些是未知数未知数
    alpha_r = 5.669*epsilon/(T_s-T_a)*(((273+T_s)/100)**4-((273+T_a)/100)**4) #辐射换热系数
    if W == 0:
...
q = q_max
sol_root1 = root(GB50264_q_to_T_s,[50,D_0+0.04,D_0+0.20]) 
sol_fsolve1 = fsolve(GB50264_q_to_T_s,[50,D_0+0.04,D_0+0.20])
T_s = sol_fsolve1[0]
D_1 = sol_fsolve1[1]
D_2 = sol_fsolve1[2]
print(" ")
